package com.github.simplenpcframework.nms.v1_15_R1;
...
public class NPC_v1_15_R1 extends NPCBase {
    ...
    public Hologram getPlayerHologram(Player player) {
        ...
        if (holo == null){
            holo = new Hologram(com.github.simplenpcframework.internal.MinecraftVersion.V1_15_R1, location.clone().add(0, 0.5, 0), getPlayerLines(player));
        }
