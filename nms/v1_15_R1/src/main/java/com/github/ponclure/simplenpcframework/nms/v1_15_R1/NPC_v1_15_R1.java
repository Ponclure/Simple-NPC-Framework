...
import com.github.ponclure.simplenpcframework.nms.v1_15_R1.packets.*;
...
public class NPC_v1_15_R1 extends NPCBase {
	...
	public NPC_v1_15_R1(final SimpleNPCFramework instance, final List<String> lines) {
	...
	public void sendEquipmentPacket(final Player player, final NPCSlot slot, final boolean auto) {
		...
		final PacketPlayOutEntityEquipment packet = new PacketPlayOutEntityEquipment(entityId, nmsSlot, CraftItemStack.asNMSCopy(item));
		playerConnection.sendPacket(packet);
	}
