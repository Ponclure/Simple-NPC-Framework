...
import com.github.simplenpcframework.api.events.NPCHideEvent;
import com.github.simplenpcframework.api.events.NPCShowEvent;
...
public abstract class NPCBase implements NPC, NPCPacketHandler {
	...
	protected SimpleNPCFramework instance;
	...
	public NPCBase(SimpleNPCFramework instance, List<String> text) {
	...
	public NPC setPlayerLines(List<String> uniqueLines, Player targetPlayer, boolean update) {
		...
		if (update) {
			...
			uniqueLines = getPlayerLines(targetPlayer); // retrieve the player lines from this function, incase it's
														// been removed.
